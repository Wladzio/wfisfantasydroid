...
//		pDialog.show();
		...
		//pDialog.dismiss();
		//finish();
		//No wszystko fajnie, tylko jak potem zamkn�� to okienko i wywo�a� finish? mo�na to zrobi� w procesie?
		//da si�: http://stackoverflow.com/questions/8623823/finish-the-calling-activity-when-asynctask-completes
		return;
	}
}
