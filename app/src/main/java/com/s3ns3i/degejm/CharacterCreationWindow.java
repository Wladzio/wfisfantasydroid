...
// TODO Trzeba zrobi� odbieranie id przy tworzeniu postaci i zapisywanie go na dysku urz�dzenia.
...
//			//=============================================================================================
//			/**	TODO
//			 * Nie mog� utworzy� gracza bez wstawiania czego� do konstruktora.
//			 * Musz� utworzy� gracza bez �adnych wst�pnych danych bo one s� dodawane dopiero p�niej.
//			 */
//			//player = new Player();
//			//=============================================================================================
//			//	DELETE AFTER ADDING THIS MODULE TO A MENU AND PASS PLAYER AS AN ARGUMENT INSTEAD
